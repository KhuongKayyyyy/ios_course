...
extension Color {
    static let tabBarBorderFixed = Color("Tab Bar Border").opacity(0.5)
    static let forecastCardBackgroundFixed = Color("Forecast Card Background")
    static let probabilityTextFixed = Color("Probability Text")
